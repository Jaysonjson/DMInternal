...
Layers are checked inside the TardisBlockEntities tick, to add a custom check for your layer or to extend our checks for custom mod blocks/biomes you can make new entries into *data/your_namespace/tardis/layer/*
...
----
**type** represents the type to check, the types can be either **block** or **biome**. +
**object** is the object to check, so either a blockId or a biomeId. +
**layer** layer will be the layer to apply. +
=======
== Sonics
